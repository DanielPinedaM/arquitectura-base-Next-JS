...
3) Por cada tipo de node_modules/react-day-picker que use Date (ej. Matcher, Formatters, Labels,
...
4) PROHIBIDO usar `any`. Usar tipado estricto.
...
5) PROHIBIDO modificar node_modules

6) En react-day-picker solo se permiten actualizaciones de tipo patch (10.0.x),
ya que cambios minor o major pueden dañar el componente de calendario.

7) Estructura del componente:
- data-types/types/calendar.type.ts → tipos publicos e internos migrados a Luxon
- helpers/calendar.helper.tsx       → funciones traductoras Luxon <-> Date (frontera con react-day-picker)
...
import { buttonVariants } from '@shad-cn/button-const';
import { LuChevronLeft, LuChevronRight, LuChevronDown } from 'react-icons/lu';

import { CalendarDayButton } from '@shad-cn/CalendarDayButton';
import {
  dateTimeToJsDate,
  toDayPickerMatchers,
...
} from '@shad-cn/calendar-helper';
import type { CalendarProps } from '@shad-cn/calendar-type';
